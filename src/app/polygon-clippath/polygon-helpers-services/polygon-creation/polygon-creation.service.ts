...
import {ClipCorner, ClipSide, ClipSidePairs, IPolygonConfig, IPolygonPoints} from '../../../../models/polygon-shape.types';
...
export class PolygonCreationService extends PolygonAbstractConfig<IPolygonConfig, IPolygonPoints> {
    ...
    protected configLeftSide(configSide: IPolygonConfig): IPolygonPoints {
    ...
    protected configRightSide(configSide: IPolygonConfig): IPolygonPoints {
        const {Right} = configSide;
        const poly = this.baseConfig(Right.degAngle, ClipSide.Right, Right.clipCorner as ClipCorner);
        return this.config.polygonArithmetic(poly);
    }

    protected configBothSides(configSides: IPolygonConfig): IPolygonPoints {
